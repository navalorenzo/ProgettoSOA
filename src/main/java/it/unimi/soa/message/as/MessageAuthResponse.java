...
public class MessageAuthResponse {
    ...
    public MessageAuthResponse createJSONToken(String username, String ipAddr, String ticketGrantingPassword, String userPassword) throws InvalidKeySpecException, NoSuchAlgorithmException, NoSuchPaddingException, BadPaddingException, IllegalBlockSizeException, InvalidKeyException {
